		...
		<div class="cold-md-7">
			...
			<form action="UserUpdate" method="POST">
				...
				<div class="form-floating mb-3">
					...
					<div class="form-floating mb-3">
						<input value="${cliente.genero}" name="genero" maxlength="40" type="text" class="form-control"> 
					...
					<div class="form-floating mb-3">
						<input value="${cliente.email}" name="email" maxlength="80" type="text" class="form-control"> 
						<label>e-mail</label>
					</div>
					
					<div class="form-floating mb-3">
						<input value="${cliente.telefone}" name="telefone" maxlength="20" type="text" class="form-control"> 
						<label>Telefone (com DDD)</label>
					</div>
					
					<div class="form-floating mb-3">
						<input value="${cliente.busca}" name="busca" maxlength="100" type="text" class="form-control"> 
						<label>Qual tipo de ajuda você procura?</label>
					</div>
